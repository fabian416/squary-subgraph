...
exports.NetworkLogo = exports.networkMapping = exports.NetworkLogos = void 0;
const material_1 = require("@mui/material");
exports.NetworkLogos = {
...
exports.networkMapping = {
  mainnet: "ethereum",
  binance: "bsc",
  xdai: "celo",
};
const NetworkLogo = ({ network, size, tooltip }) => {
  let src = exports.NetworkLogos[network];
  let opacity = 1;
  if (!src) {
    src = exports.NetworkLogos[exports.networkMapping[network]];
  }
  if (!src) {
    src = exports.NetworkLogos.ethereum;
    opacity = 0;
  }
  return (
    <material_1.Tooltip style={{ whiteSpace: "pre-wrap" }} title={tooltip} placement="bottom">
      <material_1.Avatar sx={{ height: size, width: size, opacity }} src={src} />
    </material_1.Tooltip>
  );
};
exports.NetworkLogo = NetworkLogo;
