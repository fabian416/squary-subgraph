...
exports.SubgraphLogo = void 0;
const material_1 = require("@mui/material");
const subgraphLogoMap = {
...
const SubgraphLogo = ({ name, size }) => {
  ...
  return <material_1.Avatar src={src} sx={{ height: size, width: size, opacity }} />;
};
exports.SubgraphLogo = SubgraphLogo;
