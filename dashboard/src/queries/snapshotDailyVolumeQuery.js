...
exports.getSnapshotDailyVolume = void 0;
const constants_1 = require("../constants");
const getSnapshotDailyVolume = (version, type) => {
  if (version?.includes(constants_1.Versions.Schema120.split(".0")[0]) && type === "EXCHANGE") {
    return `
...
exports.getSnapshotDailyVolume = getSnapshotDailyVolume;
