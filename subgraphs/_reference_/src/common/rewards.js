...
function getStartingBlockRate() {
  ...
  if (configure_1.NetworkConfigs.getNetwork() == constants_1.Network.MAINNET) {
    ...
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.AURORA
  ) {
    return graph_ts_1.BigDecimal.fromString("1.03");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.BSC
  ) {
    return graph_ts_1.BigDecimal.fromString("5");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.CELO
  ) {
    return graph_ts_1.BigDecimal.fromString("5");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.FANTOM
  ) {
    return graph_ts_1.BigDecimal.fromString("1");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.FUSE
  ) {
    return graph_ts_1.BigDecimal.fromString("1");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.OPTIMISM
  ) {
    return graph_ts_1.BigDecimal.fromString("12.5");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.MATIC
  ) {
    return graph_ts_1.BigDecimal.fromString("2");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.XDAI
  ) {
    return graph_ts_1.BigDecimal.fromString("5");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.MOONBEAM
  ) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.MOONRIVER
  ) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.AVALANCHE
  ) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.CRONOS
  ) {
    return graph_ts_1.BigDecimal.fromString("5.5");
  } else if (
    configure_1.NetworkConfigs.getNetwork() == constants_1.Network.BASE
  ) {
