...
const DydxGovernor_1 = require("../../../generated/DydxGovernor/DydxGovernor");
const Executor_1 = require("../../../generated/DydxGovernor/Executor");
const GovernanceStrategy_1 = require("../../../generated/DydxGovernor/GovernanceStrategy");
...
function getGovernanceFramework(contractAddress) {
  ...
  if (!governanceFramework) {
    ...
    const contract = DydxGovernor_1.DydxGovernor.bind(
...
function getQuorumFromContract(contractAddress, executorAddress, blockNumber) {
  ...
  const contract = DydxGovernor_1.DydxGovernor.bind(contractAddress);
