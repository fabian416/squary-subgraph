...
const ERC20_1 = require("../../generated/BentoBox/ERC20");
const ERC20SymbolBytes_1 = require("../../generated/BentoBox/ERC20SymbolBytes");
const ERC20NameBytes_1 = require("../../generated/BentoBox/ERC20NameBytes");
...
function getStaticDefinitions() {
  let staticDefinitions = [];
  // Add DGD
  let tokenDGD = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0xe0b7927c4af23765cb51314a0e0521a9645f0e2a"),
    "DGD",
    "DGD",
    9
  );
  ...
  let tokenAAVE = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9"),
    "AAVE",
    "Aave Token",
    18
  );
  ...
  let tokenLIF = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0xeb9951021698b42e4399f9cbb6267aa35f82d59d"),
    "LIF",
    "Lif",
    18
  );
  ...
  let tokenSVD = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0xbdeb4b83251fb146687fa19d1c660f99411eefe3"),
    "SVD",
    "savedroid",
    18
  );
  ...
  let tokenTheDAO = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0xbb9bc244d798123fde783fcc1c72d3bb8c189413"),
    "TheDAO",
    "TheDAO",
    16
  );
  ...
  let tokenHPB = new StaticTokenDefinition(
    graph_ts_1.Address.fromString("0x38c6a68304cdefb9bec48bbfaaba5c5b47818bb2"),
    "HPB",
    "HPBCoin",
    18
  );
