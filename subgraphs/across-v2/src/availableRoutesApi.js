...
exports.findDestinationToken = exports.findOriginToken = void 0;
...
class Route {}
function findOriginToken(originChainId, destinationChainId, destinationToken) {
...
exports.findOriginToken = findOriginToken;
function findDestinationToken(originChainId, destinationChainId, originToken) {
  for (let i = 0; i < availableRoutes.length; i++) {
    const route = availableRoutes[i];
    if (
      route.originChainId == originChainId &&
...
exports.findDestinationToken = findDestinationToken;
