...
const IERC20Detailed_1 = require("../../generated/ibALPACA/IERC20Detailed");
const IERC20DetailedBytes_1 = require("../../generated/ibALPACA/IERC20DetailedBytes");
...
function fetchTokenName(contract) {
  ...
  const contractNameBytes = IERC20DetailedBytes_1.IERC20DetailedBytes.bind(
    contract._address
  );
...
function fetchTokenSymbol(contract) {
  const contractSymbolBytes = IERC20DetailedBytes_1.IERC20DetailedBytes.bind(
    contract._address
  );
...
function getOrCreateRewardToken(
  ...
  const id = (0, strings_1.prefixID)(
    rewardTokenType,
    (0, strings_1.prefixID)(interestRateType, tokenAddress.toHexString())
  );
