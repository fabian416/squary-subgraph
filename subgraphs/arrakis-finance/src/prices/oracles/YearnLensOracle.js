...
const YearnLensContract_1 = require("../../../generated/templates/ArrakisVault/YearnLensContract");
function getYearnLensContract(network) {
  return YearnLensContract_1.YearnLensContract.bind(
    graph_ts_1.Address.fromString(
      constants.YEARN_LENS_CONTRACT_ADDRESS.get(network)
    )
  );
}
