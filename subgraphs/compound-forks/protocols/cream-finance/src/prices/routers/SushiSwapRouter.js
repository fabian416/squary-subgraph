...
const SushiSwapPair_1 = require("../../../../../generated/templates/CToken/SushiSwapPair");
const SushiSwapRouter_1 = require("../../../../../generated/templates/CToken/SushiSwapRouter");
...
function getPriceFromRouter(token0Address, token1Address, network) {
  ...
  let amountOutArray;
  if (routerAddressV1) {
    const sushiSwapRouterV1 =
      SushiSwapRouter_1.SushiSwapRouter.bind(routerAddressV1);
    amountOutArray = sushiSwapRouterV1.try_getAmountsOut(amountIn, path);
    if (amountOutArray.reverted && routerAddressV2) {
      const sushiSwapRouterV2 =
        SushiSwapRouter_1.SushiSwapRouter.bind(routerAddressV2);
...
function getLpTokenPriceUsdc(tokenAddress, network) {
  ...
  const pairDecimals = utils.readValue(
