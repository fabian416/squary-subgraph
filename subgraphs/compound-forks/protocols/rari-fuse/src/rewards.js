...
function getRewardsPerDay(
  ...
  if (windowSecondsCount.equals(constants_2.BIGDECIMAL_ZERO)) {
    unnormalizedBlockSpeed = constants_2.BIGDECIMAL_ZERO;
  } else {
...
function getStartingBlockRate() {
  ...
  } else if (network == exports.ARBITRUM.toLowerCase()) {
...
function emissionsPerDay(rewardRatePerSecond) {
  ...
  const BIGINT_SECONDS_PER_DAY = graph_ts_1.BigInt.fromI32(
