...
function getStartingBlockRate() {
  ...
  if (network == constants_2.Network.MAINNET) {
  ...
  } else if (network == constants_2.Network.FUSE) {
    return graph_ts_1.BigDecimal.fromString("1");
    ...
    return graph_ts_1.BigDecimal.fromString("5");
  } else if (network == constants_2.Network.MOONBEAM) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (network == constants_2.Network.MOONRIVER) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (network == constants_2.Network.AVALANCHE) {
    return graph_ts_1.BigDecimal.fromString("13.39");
  } else if (network == constants_2.Network.CRONOS) {
