...
const CalculationsSushiSwap_1 = require("../../../generated/templates/PoolTemplate/CalculationsSushiSwap");
function getTokenPriceUSDC(tokenAddr, block = null) {
  ...
  const curveContract =
    CalculationsSushiSwap_1.CalculationsSushiSwap.bind(contractAddress);
