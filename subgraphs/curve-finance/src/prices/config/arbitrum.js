...
exports.YEARN_LENS_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x043518ab266485dc085a1db095b8d9c2fc78e9b9"),
  graph_ts_1.BigInt.fromI32(2396321)
);
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x735247fb0a604c0adc6cab38ace16d0dba31295f"),
  graph_ts_1.BigInt.fromI32(781467)
);
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0xb56c2f0b653b2e0b10c9b928c8580ac5df02c7c7"),
  graph_ts_1.BigInt.fromI32(7740843)
);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x3268c3bda100ef0ff3c2d044f23eab62c80d78d2"),
  graph_ts_1.BigInt.fromI32(11707234)
);
exports.CURVE_REGISTRY_ADDRESSES = [
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x445fe580ef8d70ff569ab36e80c647af338db351"),
    graph_ts_1.BigInt.fromI32(1362056)
  ),
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x0e9fbb167df83ede3240d6a5fa5d40c6c6851e15"),
    graph_ts_1.BigInt.fromI32(4530115)
  ),
];
///////////////////////////////////////////////////////////////////////////
...
exports.YEARN_LENS_BLACKLIST = [
  ...
  graph_ts_1.Address.fromString("0xf0b5ceefc89684889e5f7e0a7775bd100fcd3709"),
  graph_ts_1.Address.fromString("0xdbcd16e622c95acb2650b38ec799f76bfc557a0b"),
