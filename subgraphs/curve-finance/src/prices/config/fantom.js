...
exports.YEARN_LENS_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x57aa88a0810dfe3f9b71a9b179dd8bf5f956c46a"),
  graph_ts_1.BigInt.fromI32(17091856)
);
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0xe8e598a1041b6fdb13999d275a202847d9b654ca"),
  graph_ts_1.BigInt.fromI32(34026291)
);
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0xfd6f3c1845604c8ae6c6e402ad17fb9885160754"),
  graph_ts_1.BigInt.fromI32(33142059)
);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x0b53e9df372e72d8fdcdbedfbb56059957a37128"),
  graph_ts_1.BigInt.fromI32(27067399)
);
exports.CURVE_REGISTRY_ADDRESSES = [
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x0f854ea9f38cea4b1c2fc79047e9d0134419d5d6"),
    graph_ts_1.BigInt.fromI32(5655918)
  ),
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x4fb93d7d320e8a263f22f62c2059dfc2a8bcbc4c"),
    graph_ts_1.BigInt.fromI32(27552509)
  ),
];
///////////////////////////////////////////////////////////////////////////
...
exports.SUSHISWAP_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x44536de2220987d098d1d29d3aafc7f7348e9ee4"),
  graph_ts_1.BigInt.fromI32(3809480)
);
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0xbe4fc72f8293f9d3512d58b969c98c3f676cb957"), // Uniswap
  ...
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x16327e3fbdaca3bcf7e38f5af2599d2ddc33ae52"), // Spiritswap
...
exports.WHITELISTED_TOKENS.set(
  ...
  types_1.TokenInfo.set(
    "USDC",
    6,
    graph_ts_1.Address.fromString("0x04068da6c83afcfa0e13ba15a6696662335d5b75")
  )
);
exports.WHITELISTED_TOKENS.set(
  "USDT",
  types_1.TokenInfo.set(
    "USDT",
    6,
    graph_ts_1.Address.fromString("0x049d68029688eabf473097a2fc38ef61633a3c7a")
  )
);
exports.WHITELISTED_TOKENS.set(
  "DAI",
  types_1.TokenInfo.set(
    "DAI",
    18,
    graph_ts_1.Address.fromString("0x8d11ec38a3eb5e956b052f67da8bdc9bef8abf3e")
  )
);
exports.WHITELISTED_TOKENS.set(
  "WETH",
  types_1.TokenInfo.set(
    "WETH",
    18,
    graph_ts_1.Address.fromString("0x25c130b2624cf12a4ea30143ef50c5d68cefa22f")
  )
);
exports.WHITELISTED_TOKENS.set(
  "NATIVE_TOKEN",
  types_1.TokenInfo.set(
    "WFTM",
    18,
    graph_ts_1.Address.fromString("0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83")
  )
);
class config {
  yearnLens() {
