...
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x3c90887ede8d65ccb2777a5d577beab2548280ad"),
  graph_ts_1.BigInt.fromI32(23930344)
);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_REGISTRY_ADDRESSES = [
  types_1.ContractInfo.set(
    ...
    graph_ts_1.BigInt.fromI32(18003250)
  ),
];
///////////////////////////////////////////////////////////////////////////
...
exports.WHITELISTED_TOKENS.set(
  ...
  types_1.TokenInfo.set(
    "WETH",
    18,
    graph_ts_1.Address.fromString("0x6983d1e6def3690c4d616b13597a09e6193ea013")
  )
);
exports.WHITELISTED_TOKENS.set(
  "NATIVE_TOKEN",
  types_1.TokenInfo.set(
    "WONE",
    18,
    graph_ts_1.Address.fromString("0xcf664087a5bb0237a0bad6742852ec6c8d69a27a")
  )
);
class config {
  yearnLens() {
