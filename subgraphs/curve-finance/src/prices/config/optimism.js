...
exports.YEARN_LENS_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0xb082d9f4734c535d9d80536f7e87a6f4f471bf65"),
  graph_ts_1.BigInt.fromI32(18109291)
);
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x11dee30e710b8d4a8630392781cc3c0046365d4c"),
  graph_ts_1.BigInt.fromI32(0)
);
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0xd81eb3728a631871a7ebbad631b5f424909f0c77"),
  graph_ts_1.BigInt.fromI32(4365625)
);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x0ffe8434eae67c9838b12c3cd11ac4005daa7227"),
  graph_ts_1.BigInt.fromI32(18368996)
);
exports.CURVE_REGISTRY_ADDRESSES = [
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0xc5cfada84e902ad92dd40194f0883ad49639b023"),
    graph_ts_1.BigInt.fromI32(2373837)
  ),
  types_1.ContractInfo.set(
    graph_ts_1.Address.fromString("0x7da64233fefb352f8f501b357c018158ed8aa455"),
    graph_ts_1.BigInt.fromI32(3729171)
  ),
];
///////////////////////////////////////////////////////////////////////////
...
exports.SUSHISWAP_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(
  graph_ts_1.Address.fromString("0x5fd3815dcb668200a662114fbc9af13ac0a55b4d"),
  graph_ts_1.BigInt.fromI32(18216910)
);
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
  types_1.ContractInfo.set(
