...
const YearnLensContract_1 = require("../../../generated/templates/PoolTemplate/YearnLensContract");
function getTokenPriceUSDC(tokenAddr, block = null) {
  ...
  const yearnLensContract =
    YearnLensContract_1.YearnLensContract.bind(contractAddress);
