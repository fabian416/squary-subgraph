...
const CurvePool_1 = require("../../../generated/templates/PoolTemplate/CurvePool");
const CurveRegistry_1 = require("../../../generated/templates/PoolTemplate/CurveRegistry");
...
function getCurvePriceUsdc(lpAddress, block = null) {
  ...
  const decimalsAdjustment = constants.DEFAULT_DECIMALS.minus(
    graph_ts_1.BigInt.fromI32(usdcTokenDecimals)
  );
  const priceUsdc = virtualPrice
    .times(basePrice.usdPrice)
    .times(utils.exponentToBigDecimal(decimalsAdjustment.toI32()));
...
function cryptoPoolLpPriceUsdc(lpAddress, block = null) {
  ...
  const priceUsdc = totalValueUsdc
    .times(utils.exponentToBigDecimal(constants.DEFAULT_DECIMALS.toI32()))
...
function cryptoPoolTokenAmountUsdc(
  poolAddress,
  tokenAddress,
  tokenIdx,
  block = null
  ...
  const tokenValueUsdc = tokenBalance
    ...
    .div(utils.exponentToBigDecimal(tokenDecimals.toI32()));
