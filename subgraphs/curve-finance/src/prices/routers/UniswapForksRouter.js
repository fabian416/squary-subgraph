...
const UniswapPair_1 = require("../../../generated/templates/PoolTemplate/UniswapPair");
const UniswapRouter_1 = require("../../../generated/templates/PoolTemplate/UniswapRouter");
...
function getLpTokenPriceUsdc(tokenAddress, block = null) {
  ...
  const pricePerLpTokenUsdc = totalLiquidity.usdPrice
    .times(utils.exponentToBigDecimal(pairDecimals))
...
function getLpTokenTotalLiquidityUsdc(tokenAddress, block = null) {
  ...
  if (
    ...
    const liquidity0 = reserve0
      .divDecimal(utils.exponentToBigDecimal(token0Decimals.toI32()))
      .times(token0Price.usdPrice);
    const liquidity1 = reserve1
      .divDecimal(utils.exponentToBigDecimal(token1Decimals.toI32()))
