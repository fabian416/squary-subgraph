...
const CalculationsSushiSwap_1 = require("../../../generated/BasicWeeklyCalls/CalculationsSushiSwap");
function getSushiSwapContract(contract, block) {
  if (
...
function getTokenPriceUSDC(tokenAddr, block) {
  ...
  if (!calculationSushiContract) return new types_1.CustomPriceType();
