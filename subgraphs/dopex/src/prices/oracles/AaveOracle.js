...
const AaveOracleContract_1 = require("../../../generated/BasicWeeklyCalls/AaveOracleContract");
function getAaveOracleContract(contract, block) {
  if (
...
function getTokenPriceUSDC(tokenAddr, block) {
  ...
  if (!aaveOracleContract) return new types_1.CustomPriceType();
