...
const UniswapPair_1 = require("../../../generated/BasicWeeklyCalls/UniswapPair");
const UniswapRouter_1 = require("../../../generated/BasicWeeklyCalls/UniswapRouter");
...
function getTokenPriceUSDC(tokenAddress, block) {
...
function getPriceFromRouterUSDC(tokenAddress, usdcAddress, block) {
  return getPriceFromRouter(tokenAddress, usdcAddress, block);
}
exports.getPriceFromRouterUSDC = getPriceFromRouterUSDC;
function getPriceFromRouter(token0Address, token1Address, block) {
  const config = utils.getConfig();
  const ethAddress = config.ethAddress();
...
function getLpTokenPriceUsdc(tokenAddress, block) {
...
function getLpTokenTotalLiquidityUsdc(tokenAddress, block) {
  const uniSwapPair = UniswapPair_1.UniswapPair.bind(tokenAddress);
