...
class LoadPositionResponse {
    constructor(position, isExistingOpenPosition) {
...
class PositionManager {
    ...
    getPositionId(pool, account, positionSide) {
    ...
    loadPosition(pool, account, asset, collateral, positionSide, openTrade) {
        ...
        const position = new Position(this.protocol, this.tokens, pool, account, entity);
...
class Position {
    ...
    closePosition(isExistingOpenPosition) {
        const event = this.protocol.getCurrentEvent();
