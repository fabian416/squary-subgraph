...
///// Protocol Specific /////
/////////////////////////////
exports.PROTOCOL_PERFORMANCE_FEE = graph_ts_1.BigDecimal.fromString("10"); // Hardcoded in contracts
exports.REGISTRY_ADDRESS_MAP = new graph_ts_1.TypedMap();
exports.REGISTRY_ADDRESS_MAP.set("mainnet", graph_ts_1.Address.fromString("0x31ccdb5bd6322483bebd0787e1dabd1bf1f14946"));
exports.REGISTRY_ADDRESS_MAP.set("arbitrum-one", graph_ts_1.Address.fromString("0xAad4760477750E251E1cc9bC35D33571CdF5e0e6"));
exports.REGISTRY_ADDRESS_MAP.set("optimism", graph_ts_1.Address.fromString("0xF5BFA20F4A77933fEE0C7bB7F39E7642A070d599"));
exports.REGISTRY_ADDRESS_MAP.set("matic", graph_ts_1.Address.fromString("0x0Ac4C7b794f3D7e7bF1093A4f179bA792CF15055"));
var PriceSource;
...
exports.TOKEN_PRICE_SOURCE_SKIPS.set(graph_ts_1.Address.fromString("0x77fba179c79de5b7653f68b5039af940ada60ce0"), [PriceSource.YEARN]);
exports.TOKEN_PRICE_SOURCE_SKIPS.set(graph_ts_1.Address.fromString("0x1321f1f1aa541a56c31682c57b80ecfccd9bb288"), [
    PriceSource.YEARN,
