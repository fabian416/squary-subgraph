...
const UniswapPair_1 = require("../../../generated/templates/Hypervisor/UniswapPair");
...
exports.USDC_DECIMALS_MAP.set(MAINNET.NETWORK_STRING, graph_ts_1.BigInt.fromI32(MAINNET.USDC_DECIMALS));
exports.USDC_DECIMALS_MAP.set(BSC.NETWORK_STRING, graph_ts_1.BigInt.fromI32(BSC.USDC_DECIMALS));
exports.USDC_DECIMALS_MAP.set(FANTOM.NETWORK_STRING, graph_ts_1.BigInt.fromI32(FANTOM.USDC_DECIMALS));
exports.USDC_DECIMALS_MAP.set(ARBITRUM_ONE.NETWORK_STRING, graph_ts_1.BigInt.fromI32(ARBITRUM_ONE.USDC_DECIMALS));
exports.USDC_DECIMALS_MAP.set(POLYGON.NETWORK_STRING, graph_ts_1.BigInt.fromI32(POLYGON.USDC_DECIMALS));
