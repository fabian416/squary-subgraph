...
exports.SUSHISWAP_WETH_ADDRESS = graph_ts_1.Address.fromString("0x0000000000000000000000000000000000000000");
...
exports.UNISWAP_ROUTER_ADDRESS.set("routerV1", graph_ts_1.Address.fromString("0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8") // Biswap v2 Router
);
exports.UNISWAP_ROUTER_ADDRESS.set("routerV2", graph_ts_1.Address.fromString("0x10ED43C718714eb63d5aA57B78B54704E256024E") // Pancakeswap v2 Router
);
...
///////////////////////////////// HELPERS /////////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.USDC_DECIMALS = 18;
exports.WHITELIST_TOKENS = new graph_ts_1.TypedMap();
exports.WHITELIST_TOKENS.set("WETH", graph_ts_1.Address.fromString("0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c"));
exports.WHITELIST_TOKENS.set("USDT", graph_ts_1.Address.fromString("0x55d398326f99059ff775485246999027b3197955"));
exports.WHITELIST_TOKENS.set("DAI", graph_ts_1.Address.fromString("0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3"));
exports.WHITELIST_TOKENS.set("USDC", graph_ts_1.Address.fromString("0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d"));
exports.WHITELIST_TOKENS.set("ETH", graph_ts_1.Address.fromString("0x2170ed0880ac9a755fd29b2688956bd959f933f8"));
exports.WHITELIST_TOKENS.set("WBTC", graph_ts_1.Address.fromString("0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c"));
exports.WHITELIST_TOKENS.set("EURS", graph_ts_1.Address.fromString("0x0000000000000000000000000000000000000000"));
exports.WHITELIST_TOKENS.set("LINK", graph_ts_1.Address.fromString("0xf8a0bf9cf54bb92f17374d9e9a321e6a111a51bd"));
