...
///////////////////////////////////////////////////////////////////////////
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x7f069df72b7a39bce9806e3afaf579e54d8cf2b9"), graph_ts_1.BigInt.fromI32(15030523));
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xb023e699f5a33916ea823a16485e259257ca8bd1"), graph_ts_1.BigInt.fromI32(25825996));
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_REGISTRY_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x094d12e5b541784701fd8d65f11fc0598fbc6332"), graph_ts_1.BigInt.fromI32(13991825)),
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x47bb542b9de58b970ba50c9dae444ddb4c16751a"), graph_ts_1.BigInt.fromI32(23556360)),
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// UNISWAP FORKS CONTRACT ////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xa5e0829caced8ffdd4de3c43696c57f7d7a678ff"), // QuickSwap
...
exports.HARDCODED_STABLES = [
    ...
    graph_ts_1.Address.fromString("0x7bdf330f423ea880ff95fc41a280fd5ecfd3d09f"), // Euro Tether (PoS)
];
///////////////////////////////////////////////////////////////////////////
///////////////////////////////// HELPERS /////////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.WHITELISTED_TOKENS = new graph_ts_1.TypedMap();
exports.WHITELISTED_TOKENS.set("USDC", types_1.TokenInfo.set("USDC", 6, graph_ts_1.Address.fromString("0x2791bca1f2de4661ed88a30c99a7a9449aa84174")));
exports.WHITELISTED_TOKENS.set("USDT", types_1.TokenInfo.set("USDT", 6, graph_ts_1.Address.fromString("0xc2132d05d31c914a87c6611c10748aeb04b58e8f")));
exports.WHITELISTED_TOKENS.set("DAI", types_1.TokenInfo.set("DAI", 18, graph_ts_1.Address.fromString("0x8f3cf7ad23cd3cadbd9735aff958023239c6a063")));
exports.WHITELISTED_TOKENS.set("WETH", types_1.TokenInfo.set("WETH", 18, graph_ts_1.Address.fromString("0x7ceb23fd6bc0add59e62ac25578270cff1b9f619")));
exports.WHITELISTED_TOKENS.set("NATIVE_TOKEN", types_1.TokenInfo.set("MATIC", 18, graph_ts_1.Address.fromString("0x0000000000000000000000000000000000001010")));
class config {
    yearnLens() {
        return null;
    }
