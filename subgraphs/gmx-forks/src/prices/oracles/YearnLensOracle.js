...
const YearnLensContract_1 = require("../../../generated/templates/MlpManagerTemplate/YearnLensContract");
function getTokenPriceUSDC(tokenAddr, block = null) {
    ...
    const yearnLensContract = YearnLensContract_1.YearnLensContract.bind(contractAddress);
    const tokenPrice = utils
        .readValue(yearnLensContract.try_getPriceUsdcRecommended(tokenAddr), constants.BIGINT_ZERO)
        .toBigDecimal();
    return types_1.CustomPriceType.initialize(tokenPrice, constants.DEFAULT_USDC_DECIMALS, constants.OracleType.YEARN_LENS_ORACLE);
}
