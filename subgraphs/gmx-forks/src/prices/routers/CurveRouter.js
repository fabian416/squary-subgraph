...
const CurvePool_1 = require("../../../generated/templates/MlpManagerTemplate/CurvePool");
const CurveRegistry_1 = require("../../../generated/templates/MlpManagerTemplate/CurveRegistry");
...
function getCurvePriceUsdc(lpAddress, block = null) {
    ...
    const decimalsAdjustment = constants.DEFAULT_DECIMALS.minus(graph_ts_1.BigInt.fromI32(usdcTokenDecimals));
    const priceUsdc = virtualPrice
        .times(basePrice.usdPrice)
        .times(constants.BIGINT_TEN.pow(decimalsAdjustment.toI32()).toBigDecimal());
    return types_1.CustomPriceType.initialize(priceUsdc, decimalsAdjustment.plus(constants.DEFAULT_DECIMALS).toI32(), constants.OracleType.CURVE_ROUTER);
}
