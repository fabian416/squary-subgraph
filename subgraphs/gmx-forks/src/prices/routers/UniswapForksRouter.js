...
const UniswapPair_1 = require("../../../generated/templates/MlpManagerTemplate/UniswapPair");
const UniswapRouter_1 = require("../../../generated/templates/MlpManagerTemplate/UniswapRouter");
...
function getPriceFromRouter(token0Address, token1Address, block = null) {
    ...
    if (token0Address == nativeTokenAddress)
        token0Address = wethAddress;
    if (token1Address == nativeTokenAddress)
    ...
    const amountOutBigDecimal = amountOut
        ...
        .toBigDecimal();
    return types_1.CustomPriceType.initialize(amountOutBigDecimal, config.whitelistedTokens().mustGet(constants.STABLE_TOKENS_STRINGS.USDC)
        .decimals, constants.OracleType.UNISWAP_FORKS_ROUTER);
}
