...
const GovernorBeta_1 = require("../../../generated/GovernorBeta/GovernorBeta");
...
function getLatestProposalValues(proposalId, contractAddress) {
    ...
    if (proposal.state == constants_1.ProposalState.PENDING) {
        const contract = GovernorBeta_1.GovernorBeta.bind(contractAddress);
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = GovernorBeta_1.GovernorBeta.bind(graph_ts_1.Address.fromString(contractAddress));
