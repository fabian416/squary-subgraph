...
const CalculationsCurve_1 = require("../../../generated/FuturesMarketManager2/CalculationsCurve");
...
function getTokenPriceUSDC(tokenAddr, block = null) {
    ...
    const calculationCurveContract = getCalculationsCurveContract(config.curveCalculations(), block);
