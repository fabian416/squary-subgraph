...
exports.ETH_NAME = exports.ETH_SYMBOL = exports.MS_PER_YEAR = exports.DAYS_PER_YEAR = exports.MS_PER_DAY = exports.SECONDS_PER_HOUR_BI = exports.SECONDS_PER_DAY_BI = exports.SECONDS_PER_HOUR = exports.SECONDS_PER_DAY = exports.MAX_UINT = exports.BIGDECIMAL_MINUS_ONE = exports.BIGDECIMAL_HUNDRED = exports.BIGDECIMAL_TWO = exports.BIGDECIMAL_ONE = exports.BIGDECIMAL_ZERO = exports.INT_FOUR = exports.INT_TWO = exports.INT_ONE = exports.INT_ZERO = exports.INT_NEGATIVE_ONE = exports.BIGINT_MAX = exports.BIGINT_MINUS_ONE = exports.BIGINT_TEN_TO_EIGHTEENTH = exports.BIGINT_THOUSAND = exports.BIGINT_HUNDRED = exports.BIGINT_TEN = exports.BIGINT_TWO = exports.BIGINT_ONE = exports.BIGINT_ZERO = exports.USDC_DENOMINATOR = exports.USDC_DECIMALS = exports.DEFAULT_DECIMALS = exports.ETH_ADDRESS = exports.ZERO_ADDRESS = exports.PositionSide = exports.UsageType = exports.InterestRateSide = exports.InterestRateType = exports.RiskType = exports.LendingType = exports.ActivityInterval = exports.RewardTokenType = exports.ParameterKeys = exports.LiquidityPoolFeeType = exports.VaultFeeType = exports.ProtocolType = exports.Network = void 0;
...
(function (LiquidityPoolFeeType) {
    ...
    LiquidityPoolFeeType.DYNAMIC_TAKER_FEE = "DYNAMIC_TAKER_FEE";
    LiquidityPoolFeeType.DYNAMIC_TAKER_DELAYED_FEE = "DYNAMIC_TAKER_DELAYED_FEE";
    LiquidityPoolFeeType.DYNAMIC_TAKER_DELAYED_OFFCHAIN_FEE = "DYNAMIC_TAKER_DELAYED_OFFCHAIN_FEE";
    LiquidityPoolFeeType.DYNAMIC_MAKER_FEE = "DYNAMIC_MAKER_FEE";
    LiquidityPoolFeeType.DYNAMIC_MAKER_DELAYED_FEE = "DYNAMIC_MAKER_DELAYED_FEE";
    LiquidityPoolFeeType.DYNAMIC_MAKER_DELAYED_OFFCHAIN_FEE = "DYNAMIC_MAKER_DELAYED_OFFCHAIN_FEE";
})(LiquidityPoolFeeType = exports.LiquidityPoolFeeType || (exports.LiquidityPoolFeeType = {}));
exports.ParameterKeys = new graph_ts_1.TypedMap();
exports.ParameterKeys.set("takerFee", LiquidityPoolFeeType.DYNAMIC_TAKER_FEE);
exports.ParameterKeys.set("takerFeeDelayedOrder", LiquidityPoolFeeType.DYNAMIC_TAKER_DELAYED_FEE);
exports.ParameterKeys.set("takerFeeOffchainDelayedOrder", LiquidityPoolFeeType.DYNAMIC_TAKER_DELAYED_OFFCHAIN_FEE);
exports.ParameterKeys.set("makerFee", LiquidityPoolFeeType.DYNAMIC_MAKER_FEE);
exports.ParameterKeys.set("makerFeeDelayedOrder", LiquidityPoolFeeType.DYNAMIC_MAKER_DELAYED_FEE);
exports.ParameterKeys.set("makerFeeOffchainDelayedOrder", LiquidityPoolFeeType.DYNAMIC_MAKER_DELAYED_OFFCHAIN_FEE);
var RewardTokenType;
...
(function (ActivityInterval) {
    ActivityInterval.HOURLY = "HOURLY";
    ActivityInterval.DAILY = "DAILY";
