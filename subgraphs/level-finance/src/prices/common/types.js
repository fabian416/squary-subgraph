...
exports.CustomPriceType = exports.ContractInfo = exports.TokenInfo = exports.Wrapped = void 0;
...
class CustomPriceType {
    ...
    static initializePegged(_usdPrice = constants.BIGDECIMAL_USD_PRICE, _decimals = constants.DEFAULT_USDC_DECIMALS, _oracleType = "HardcodedStable") {
    ...
    get usdPrice() {
        return changetype(this._usdPrice).inner.div(constants.BIGINT_TEN.pow(this.decimals).toBigDecimal());
    }
    get decimals() {
