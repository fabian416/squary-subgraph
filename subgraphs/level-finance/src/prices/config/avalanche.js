...
///////////////////////////////////////////////////////////////////////////
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xbd0c7aaf0bf082712ebe919a9dd94b2d978f79a9"), graph_ts_1.BigInt.fromI32(8608685));
exports.AAVE_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xebd36016b3ed09d4693ed4251c67bd858c3c7c9c"), graph_ts_1.BigInt.fromI32(11970477));
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_REGISTRY_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x8474ddbe98f5aa3179b3b3f5942d724afcdec9f6"), graph_ts_1.BigInt.fromI32(5254206)),
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x90f421832199e93d01b64daf378b183809eb0988"), graph_ts_1.BigInt.fromI32(9384663)),
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// UNISWAP FORKS CONTRACT ////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x60ae616a2155ee3d9a68541ba4544862310933d4"), // TraderJOE
    graph_ts_1.BigInt.fromI32(2486393)),
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xe54ca86531e17ef3616d22ca28b0d458b6c89106"), // Pangolin
...
exports.WHITELISTED_TOKENS.set("USDC", types_1.TokenInfo.set("USDC", 6, graph_ts_1.Address.fromString("0xb97ef9ef8734c71904d8002f8b6bc66dd9c48a6e")));
exports.WHITELISTED_TOKENS.set("USDT", types_1.TokenInfo.set("USDT", 6, graph_ts_1.Address.fromString("0x9702230a8ea53601f5cd2dc00fdbc13d4df4a8c7")));
exports.WHITELISTED_TOKENS.set("DAI", types_1.TokenInfo.set("DAI", 18, graph_ts_1.Address.fromString("0xd586e7f844cea2f87f50152665bcbc2c279d8d70")));
exports.WHITELISTED_TOKENS.set("WETH", types_1.TokenInfo.set("WETH", 18, graph_ts_1.Address.fromString("0x49d5c2bdffac6ce2bfdb6640f4f80f226bc10bab")));
exports.WHITELISTED_TOKENS.set("NATIVE_TOKEN", types_1.TokenInfo.set("WAVAX", 18, graph_ts_1.Address.fromString("0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7")));
class config {
    yearnLens() {
        return null;
    }
