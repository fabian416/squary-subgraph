...
exports.config = exports.WHITELISTED_TOKENS = exports.HARDCODED_STABLES = exports.SUSHI_CALCULATIONS_BLACKSLIST = exports.AAVE_ORACLE_BLACKLIST = exports.INCH_ORACLE_BLACKLIST = exports.CURVE_CALCULATIONS_BLACKSLIST = exports.YEARN_LENS_BLACKLIST = exports.UNISWAP_FORKS_ROUTER_ADDRESSES = exports.SUSHISWAP_CALCULATIONS_ADDRESS = exports.CURVE_REGISTRY_ADDRESSES = exports.CURVE_CALCULATIONS_ADDRESS = exports.CHAIN_LINK_CONTRACT_ADDRESS = exports.INCH_ORACLE_CONTRACT_ADDRESS = exports.YEARN_LENS_CONTRACT_ADDRESS = exports.NETWORK_STRING = void 0;
...
///////////////////////////////////////////////////////////////////////////
exports.YEARN_LENS_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x83d95e0d5f402511db06817aff3f9ea88224b030"), graph_ts_1.BigInt.fromI32(12242339));
exports.INCH_ORACLE_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x07d91f5fb9bf7798734c3f606db065549f6893bb"), graph_ts_1.BigInt.fromI32(12522266));
exports.CHAIN_LINK_CONTRACT_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x47fb2585d2c56fe188d0e6ec628a38b74fceeedf"), graph_ts_1.BigInt.fromI32(12864088));
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_CALCULATIONS_ADDRESS = types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x25bf7b72815476dd515044f9650bf79bad0df655"), graph_ts_1.BigInt.fromI32(12370088));
exports.CURVE_REGISTRY_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x7d86446ddb609ed0f5f8684acf30380a356b2b4c"), graph_ts_1.BigInt.fromI32(11154794)),
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x8f942c20d02befc377d41445793068908e2250d0"), graph_ts_1.BigInt.fromI32(13986752)),
];
///////////////////////////////////////////////////////////////////////////
...
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x7a250d5630b4cf539739df2c5dacb4c659f2488d"), // Uniswap
    graph_ts_1.BigInt.fromI32(10207858)),
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xd9e1ce17f2641f24ae83637ab66a2cca9c378b9f"), // SushiSwap
...
exports.HARDCODED_STABLES = [
    ...
    graph_ts_1.Address.fromString("0x6c3f90f043a72fa612cbac8115ee7e52bde6e490"),
    graph_ts_1.Address.fromString("0x853d955acef822db058eb8505911ed77f175b99e"),
    ...
    graph_ts_1.Address.fromString("0x466a756e9a7401b5e2444a3fcb3c2c12fbea0a54"),
    graph_ts_1.Address.fromString("0x31d4eb09a216e181ec8a43ce79226a487d6f0ba9"),
    graph_ts_1.Address.fromString("0xff709449528b6fb6b88f557f7d93dece33bca78d"),
    graph_ts_1.Address.fromString("0xf0a93d4994b3d98fb5e3a2f90dbc2d69073cb86b"),
    graph_ts_1.Address.fromString("0x42ef9077d8e79689799673ae588e046f8832cb95"),
    graph_ts_1.Address.fromString("0x0e2ec54fc0b509f445631bf4b91ab8168230c752"),
    graph_ts_1.Address.fromString("0xea3fb6f331735252e7bfb0b24b3b761301293dbe"),
    graph_ts_1.Address.fromString("0x4fabb145d64652a948d72533023f6e7a623c7c53"),
    graph_ts_1.Address.fromString("0x956f47f50a910163d8bf957cf5846d573e7f87ca"),
    graph_ts_1.Address.fromString("0xc7d9c108d4e1dd1484d3e2568d7f74bfd763d356"),
...
exports.WHITELISTED_TOKENS.set("USDC", types_1.TokenInfo.set("USDC", 6, graph_ts_1.Address.fromString("0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48")));
exports.WHITELISTED_TOKENS.set("USDT", types_1.TokenInfo.set("USDT", 6, graph_ts_1.Address.fromString("0xdac17f958d2ee523a2206206994597c13d831ec7")));
...
exports.WHITELISTED_TOKENS.set("WETH", types_1.TokenInfo.set("WETH", 18, graph_ts_1.Address.fromString("0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2")));
