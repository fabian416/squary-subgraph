...
exports.CURVE_REGISTRY_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0xc2b1df84112619d190193e48148000e3990bf627"), graph_ts_1.BigInt.fromI32(1452049)),
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// UNISWAP FORKS CONTRACT ////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    types_1.ContractInfo.set(graph_ts_1.Address.fromString("0x96b244391d98b62d19ae89b1a4dccf0fc56970c7"), // BeamSwap
...
exports.WHITELISTED_TOKENS.set("USDC", types_1.TokenInfo.set("USDC", 6, graph_ts_1.Address.fromString("0x818ec0a7fe18ff94269904fced6ae3dae6d6dc0b")));
exports.WHITELISTED_TOKENS.set("USDT", types_1.TokenInfo.set("USDT", 6, graph_ts_1.Address.fromString("0xefaeee334f0fd1712f9a8cc375f427d9cdd40d73")));
exports.WHITELISTED_TOKENS.set("DAI", types_1.TokenInfo.set("DAI", 18, graph_ts_1.Address.fromString("0x765277eebeca2e31912c9946eae1021199b39c61")));
exports.WHITELISTED_TOKENS.set("WETH", types_1.TokenInfo.set("WETH", 18, graph_ts_1.Address.fromString("0x30d2a9f5fdf90ace8c17952cbb4ee48a55d916a7")));
exports.WHITELISTED_TOKENS.set("NATIVE_TOKEN", types_1.TokenInfo.set("GLMR", 18, graph_ts_1.Address.fromString("0xacc15dc74880c9944775448304b263d191c6077f")));
class config {
    yearnLens() {
        return null;
    }
