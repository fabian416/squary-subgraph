...
exports.getRewardsPerDay = exports.WINDOW_SIZE_SECONDS_BD = exports.STARTING_BLOCKS_PER_DAY = exports.RATE_IN_SECONDS_BD = exports.RATE_IN_SECONDS = exports.CIRCULAR_BUFFER = exports.BUFFER_SIZE = exports.WINDOW_SIZE_SECONDS = exports.TIMESTAMP_STORAGE_INTERVAL = void 0;
...
function getRewardsPerDay(currentTimestamp, currentBlockNumber, rewardRate, rewardType) {
    ...
    const windowBlocksCount = graph_ts_1.BigDecimal.fromString((currentBlockNumberI32 - blocks[circularBuffer.windowStartIndex + 1]).toString());
...
function getStartingBlockRate() {
    ...
    if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.MAINNET)) {
        return graph_ts_1.BigDecimal.fromString("13.39");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.ARBITRUM_ONE)) {
        return graph_ts_1.BigDecimal.fromString("15");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.AURORA)) {
        return graph_ts_1.BigDecimal.fromString("1.03");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.BSC)) {
        return graph_ts_1.BigDecimal.fromString("5");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.CELO)) {
        return graph_ts_1.BigDecimal.fromString("5");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.FANTOM)) {
        return graph_ts_1.BigDecimal.fromString("1");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.FUSE)) {
        return graph_ts_1.BigDecimal.fromString("1");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.OPTIMISM)) {
        return graph_ts_1.BigDecimal.fromString("12.5");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.MATIC)) {
        return graph_ts_1.BigDecimal.fromString("2");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.XDAI)) {
        return graph_ts_1.BigDecimal.fromString("5");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.MOONBEAM)) {
        return graph_ts_1.BigDecimal.fromString("13.39");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.MOONRIVER)) {
        return graph_ts_1.BigDecimal.fromString("13.39");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.AVALANCHE)) {
        return graph_ts_1.BigDecimal.fromString("13.39");
    }
    else if (utils.equalsIgnoreCase(graph_ts_1.dataSource.network(), constants.Network.CRONOS)) {
