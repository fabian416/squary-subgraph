...
const ERC20_1 = require("../../../../generated/MapleGlobals/ERC20");
...
function getTokenDecimals(tokenAddr) {
    ...
    const decimals = graph_ts_1.BigInt.fromI32(readValue(token.try_decimals(), constants.DEFAULT_DECIMALS.toI32()));
    return decimals;
}
