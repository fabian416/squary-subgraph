...
class SnapshotManager {
    ...
    createOrUpdateMarketHourlySnapshot() {
        const hours = this.event.block.timestamp.toI32() / constants_1.SECONDS_PER_HOUR;
    ...
    createOrUpdateMarketDailySnapshot() {
        const days = this.event.block.timestamp.toI32() / constants_1.SECONDS_PER_DAY;
    ...
    updateUsageData(transactionType, account) {
        this.usageDailySnapshot.dailyActiveUsers += (0, constants_1.activityCounter)(account, transactionType, false, this.marketDailySnapshot.days);
        this.marketDailySnapshot.dailyActiveUsers += (0, constants_1.activityCounter)(account, transactionType, false, this.marketDailySnapshot.days, this.market.id);
        this.usageHourlySnapshot.hourlyActiveUsers += (0, constants_1.activityCounter)(account, transactionType, false, this.marketHourlySnapshot.hours);
        if (transactionType == constants_1.TransactionType.DEPOSIT) {
            this.usageDailySnapshot.dailyActiveDepositors += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days);
            this.marketDailySnapshot.dailyActiveDepositors += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days, this.market.id);
        }
        if (transactionType == constants_1.TransactionType.BORROW) {
            this.usageDailySnapshot.dailyActiveBorrowers += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days);
            this.marketDailySnapshot.dailyActiveBorrowers += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days);
        }
        if (transactionType == constants_1.TransactionType.LIQUIDATOR) {
            this.usageDailySnapshot.dailyActiveLiquidators += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days);
            this.marketDailySnapshot.dailyActiveLiquidators += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days, this.market.id);
        }
        if (transactionType == constants_1.TransactionType.LIQUIDATEE) {
            this.usageDailySnapshot.dailyActiveLiquidatees += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days);
            this.marketDailySnapshot.dailyActiveLiquidatees += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days, this.market.id);
        }
        if (transactionType == constants_1.TransactionType.TRANSFER)
            this.marketDailySnapshot.dailyActiveTransferrers += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days, this.market.id);
        if (transactionType == constants_1.TransactionType.FLASHLOAN)
            this.marketDailySnapshot.dailyActiveFlashloaners += (0, constants_1.activityCounter)(account, transactionType, true, this.marketDailySnapshot.days, this.market.id);
    ...
    updateRevenue(protocolRevenueDelta, supplyRevenueDelta) {
        ...
        this.marketHourlySnapshot.hourlyProtocolSideRevenueUSD =
            this.marketHourlySnapshot.hourlyProtocolSideRevenueUSD.plus(protocolRevenueDelta);
        this.marketHourlySnapshot.hourlySupplySideRevenueUSD =
            this.marketHourlySnapshot.hourlySupplySideRevenueUSD.plus(supplyRevenueDelta);
        this.marketHourlySnapshot.save();
        ...
        this.marketDailySnapshot.dailyProtocolSideRevenueUSD =
            this.marketDailySnapshot.dailyProtocolSideRevenueUSD.plus(protocolRevenueDelta);
        this.marketDailySnapshot.dailySupplySideRevenueUSD =
            this.marketDailySnapshot.dailySupplySideRevenueUSD.plus(supplyRevenueDelta);
        this.marketDailySnapshot.save();
        ...
        this.financialSnapshot.dailyProtocolSideRevenueUSD =
            this.financialSnapshot.dailyProtocolSideRevenueUSD.plus(protocolRevenueDelta);
    ...
    addDailyActivePosition(side) {
        if (side == constants_1.PositionSide.BORROWER) {
            this.marketDailySnapshot.dailyActiveBorrowingPositionCount += constants_1.INT_ONE;
        }
        if (side == constants_1.PositionSide.COLLATERAL) {
            this.marketDailySnapshot.dailyActiveLendingPositionCount += constants_1.INT_ONE;
        }
        this.marketDailySnapshot.save();
    }
    ///////////////////
    ...
    getSnapshotRevenueDetail(currID, timeSuffix) {
        ...
        if (!currDetails) {
            graph_ts_1.log.error("[getRevenueDetailSnapshot] Cannot find revenue details id: {}", [currID.toHexString()]);
            return null;
        }
        const newDetails = new schema_1.RevenueDetail(currDetails.id.concat(graph_ts_1.Bytes.fromI32(timeSuffix)));
