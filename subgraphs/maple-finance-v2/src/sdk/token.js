...
const ERC20SymbolBytes_1 = require("../../generated/PoolManagerFactory/ERC20SymbolBytes");
const ERC20NameBytes_1 = require("../../generated/PoolManagerFactory/ERC20NameBytes");
...
class StaticTokenDefinition {
    ...
    static getStaticDefinitions() {
        const staticDefinitions = new Array(6);
        // Add DGD
        const tokenDGD = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xe0b7927c4af23765cb51314a0e0521a9645f0e2a"), "DGD", "DGD", 9);
        staticDefinitions.push(tokenDGD);
        // Add AAVE
        const tokenAAVE = new StaticTokenDefinition(graph_ts_1.Address.fromString("0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9"), "AAVE", "Aave Token", 18);
        staticDefinitions.push(tokenAAVE);
        // Add LIF
        const tokenLIF = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xeb9951021698b42e4399f9cbb6267aa35f82d59d"), "LIF", "Lif", 18);
        staticDefinitions.push(tokenLIF);
        // Add SVD
        const tokenSVD = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xbdeb4b83251fb146687fa19d1c660f99411eefe3"), "SVD", "savedroid", 18);
        staticDefinitions.push(tokenSVD);
        // Add TheDAO
        const tokenTheDAO = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xbb9bc244d798123fde783fcc1c72d3bb8c189413"), "TheDAO", "TheDAO", 16);
        staticDefinitions.push(tokenTheDAO);
        // Add HPB
        const tokenHPB = new StaticTokenDefinition(graph_ts_1.Address.fromString("0x38c6a68304cdefb9bec48bbfaaba5c5b47818bb2"), "HPB", "HPBCoin", 18);
