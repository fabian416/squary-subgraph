...
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    new types_1.OracleContract("0x145863eb42cf62847a6ca784e6416c1682b1b2ae", 5247), // VVS Finance
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// BLACKLISTED TOKENS ////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.ETH_ADDRESS = graph_ts_1.Address.fromString("0xe44fd7fcb2b1581822d0c862b68222998a0c299a");
exports.WETH_ADDRESS = graph_ts_1.Address.fromString("0x5c7f8a570d578ed84e63fdfa7b1ee72deae1ae23" // Wrapped CRO (WCRO)
);
exports.USDC_ADDRESS = graph_ts_1.Address.fromString("0xc21223249ca28397b4b6541dffaecc539bff0c59");
class config {
    network() {
