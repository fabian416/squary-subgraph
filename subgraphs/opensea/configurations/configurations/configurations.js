...
const configurations_1 = require("../../protocols/opensea-v1/config/deployments/opensea-v1-ethereum/configurations");
const configurations_2 = require("../../protocols/opensea-v2/config/deployments/opensea-v2-ethereum/configurations");
...
function getNetworkConfigurations(deploy) {
    switch (deploy) {
        case deploy_1.Deploy.OPENSEA_V1_ETHEREUM: {
            return new configurations_1.OpenSeaV1EthereumConfigurations();
        }
        case deploy_1.Deploy.OPENSEA_V2_ETHEREUM: {
            return new configurations_2.OpenSeaV2EthereumConfigurations();
        }
        default: {
