...
exports.handleVoteCast = exports.handleTimelockChange = exports.handleQuorumNumeratorUpdated = exports.handleProposalQueued = exports.handleProposalExecuted = exports.handleProposalCreated = exports.handleProposalCanceled = void 0;
const graph_ts_1 = require("@graphprotocol/graph-ts");
const handlers_1 = require("../../../src/handlers");
const ENSGovernor_1 = require("../../../generated/ENSGovernor/ENSGovernor");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = ENSGovernor_1.ENSGovernor.bind(graph_ts_1.Address.fromString(contractAddress));
...
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = ENSGovernor_1.ENSGovernor.bind(contractAddress);
