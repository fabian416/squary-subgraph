...
const FeiDAO_1 = require("../../../generated/FeiDAO/FeiDAO");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = FeiDAO_1.FeiDAO.bind(graph_ts_1.Address.fromString(contractAddress));
...
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = FeiDAO_1.FeiDAO.bind(contractAddress);
