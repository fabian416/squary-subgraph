...
const HOPGovernor_1 = require("../../../generated/HOPGovernor/HOPGovernor");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = HOPGovernor_1.HOPGovernor.bind(graph_ts_1.Address.fromString(contractAddress));
...
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = HOPGovernor_1.HOPGovernor.bind(contractAddress);
