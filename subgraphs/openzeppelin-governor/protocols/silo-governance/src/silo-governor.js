...
const SiloGovernor_1 = require("../../../generated/SiloGovernor/SiloGovernor");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = SiloGovernor_1.SiloGovernor.bind(graph_ts_1.Address.fromString(contractAddress));
...
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = SiloGovernor_1.SiloGovernor.bind(contractAddress);
