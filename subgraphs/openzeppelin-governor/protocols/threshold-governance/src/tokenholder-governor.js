...
exports.handleVotingPeriodSet = exports.handleVotingDelaySet = exports.handleVoteCast = exports.handleTimelockChange = exports.handleQuorumNumeratorUpdated = exports.handleProposalQueued = exports.handleProposalExtended = exports.handleProposalExecuted = exports.handleProposalCreated = exports.handleProposalCanceled = void 0;
const graph_ts_1 = require("@graphprotocol/graph-ts");
const handlers_1 = require("../../../src/handlers");
const TokenHolderGovernor_1 = require("../../../generated/TokenHolderGovernor/TokenHolderGovernor");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = TokenHolderGovernor_1.TokenholderGovernor.bind(graph_ts_1.Address.fromString(contractAddress));
        ...
        governanceFramework.quorumDenominator = constants_1.BIGINT_HUNDRED;
    }
    return governanceFramework;
}
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = TokenHolderGovernor_1.TokenholderGovernor.bind(contractAddress);
