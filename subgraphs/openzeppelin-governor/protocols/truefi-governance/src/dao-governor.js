...
const DaoGovernor_1 = require("../../../generated/DaoGovernor/DaoGovernor");
...
function getGovernanceFramework(contractAddress) {
    ...
    if (!governanceFramework) {
        ...
        const contract = DaoGovernor_1.DaoGovernor.bind(graph_ts_1.Address.fromString(contractAddress));
...
function getQuorumFromContract(contractAddress, blockNumber) {
    const contract = DaoGovernor_1.DaoGovernor.bind(contractAddress);
