...
class Bridge {
     ...
     */
    updateVolumes() {
        this.protocol.netVolumeUSD = this.protocol.cumulativeVolumeInUSD.minus(this.protocol.cumulativeVolumeOutUSD);
        this.protocol.cumulativeTotalVolumeUSD =
            this.protocol.cumulativeVolumeInUSD.plus(this.protocol.cumulativeVolumeOutUSD);
        this.save();
    }
    /**
