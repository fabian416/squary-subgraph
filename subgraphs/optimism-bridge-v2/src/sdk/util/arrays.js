...
exports.subtractTwoBigDecimalArrays = exports.subtractTwoBigIntArrays = exports.updateArrayAtIndex = exports.sortBytesArray = exports.sortArrayByReference = void 0;
...
function subtractTwoBigIntArrays(a, b) {
    if (a.length != b.length)
        return [];
    return a.map((valueA, indexA) => valueA.minus(b[indexA]));
}
exports.subtractTwoBigIntArrays = subtractTwoBigIntArrays;
function subtractTwoBigDecimalArrays(a, b) {
    if (a.length != b.length)
        return [];
    return a.map((valueA, indexA) => valueA.minus(b[indexA]));
}
exports.subtractTwoBigDecimalArrays = subtractTwoBigDecimalArrays;
