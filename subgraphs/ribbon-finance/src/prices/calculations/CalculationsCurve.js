...
const CalculationsCurve_1 = require("../../../generated/templates/LiquidityGauge/CalculationsCurve");
function getCalculationsCurveContract(contractAddress) {
    if (utils.isNullAddress(contractAddress))
        return null;
    return CalculationsCurve_1.CalculationsCurve.bind(contractAddress);
}
...
function getTokenPriceUSDC(tokenAddr) {
    ...
    const calculationCurveContract = getCalculationsCurveContract(config.curveCalculations());
