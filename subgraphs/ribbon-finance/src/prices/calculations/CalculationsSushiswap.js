...
const CalculationsSushiSwap_1 = require("../../../generated/templates/LiquidityGauge/CalculationsSushiSwap");
function getSushiSwapContract(contractAddress) {
    if (utils.isNullAddress(contractAddress))
        return null;
    return CalculationsSushiSwap_1.CalculationsSushiSwap.bind(contractAddress);
}
...
function getTokenPriceUSDC(tokenAddr) {
    ...
    const tokenPrice = utils
        .readValue(sushiContract.try_getPriceUsdc(tokenAddr), constants.BIGINT_ZERO)
        .toBigDecimal();
