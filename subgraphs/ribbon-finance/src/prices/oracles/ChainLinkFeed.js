...
const ChainLinkContract_1 = require("../../../generated/templates/LiquidityGauge/ChainLinkContract");
function getChainLinkContract() {
    const config = utils.getConfig();
    if (!config || utils.isNullAddress(config.chainLink()))
        return null;
    return ChainLinkContract_1.ChainLinkContract.bind(config.chainLink());
}
