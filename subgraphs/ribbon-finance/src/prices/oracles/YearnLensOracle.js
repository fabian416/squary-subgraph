...
const YearnLensContract_1 = require("../../../generated/templates/LiquidityGauge/YearnLensContract");
function getYearnLensContract(contractAddress) {
    if (utils.isNullAddress(contractAddress))
        return null;
    return YearnLensContract_1.YearnLensContract.bind(contractAddress);
}
