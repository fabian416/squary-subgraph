...
const configurations_1 = require("../../protocols/seaport/config/deployments/opensea-seaport-ethereum/configurations");
...
function getNetworkConfigurations(deploy) {
    switch (deploy) {
        case deploy_1.Deploy.OPENSEA_SEAPORT_ETHEREUM: {
            return new configurations_1.SeaportEthereumConfigurations();
        }
        default: {
