...
exports.round = exports.wadToRay = exports.rayToWad = exports.calculateMedian = exports.calculateAverage = exports.bigDecimalExponential = exports.exponentToBigDecimal = exports.bigIntToBigDecimal = void 0;
...
function rayToWad(a) {
    const halfRatio = constants_1.BIGINT_TEN.pow(INT_NINE).div(graph_ts_1.BigInt.fromI32(2));
...
function round(numberToRound) {
    ...
    const roundedNumber = Math.ceil((parsedNumber + Number.EPSILON) * INT_HUNDRED) / INT_HUNDRED;
