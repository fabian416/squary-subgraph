...
exports.createSwapHandleVolumeAndFees = exports.createWithdraw = exports.createDeposit = exports.createLiquidityPool = exports.factoryContract = void 0;
...
exports.factoryContract = Factory_1.Factory.bind(graph_ts_1.Address.fromString(constants_1.FACTORY_ADDRESS));
...
function createLiquidityPool(event, poolAddress, token0Address, token1Address) {
    ...
    pool.rewardTokenEmissionsAmount = [constants_1.BIGINT_ZERO, constants_1.BIGINT_ZERO];
    pool.rewardTokenEmissionsUSD = [constants_1.BIGDECIMAL_ZERO, constants_1.BIGDECIMAL_ZERO];
