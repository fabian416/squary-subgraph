...
exports.OracleType = exports.CustomPriceType = exports.OracleContract = exports.Wrapped = void 0;
...
class CustomPriceType {
    ...
    static initialize(_usdPrice, _decimals = 0, _oracleType = "", _liquidity = null) {
        ...
        if (_liquidity)
            result._liquidity = new Wrapped(_liquidity);
        return result;
    }
    get reverted() {
