...
exports.averagePrice = exports.kClosestPrices = exports.getConfig = exports.getTokenSupply = exports.getTokenDecimals = exports.getTokenName = exports.readValue = exports.bigIntToBigDecimal = exports.isNullAddress = void 0;
...
const _ERC20_1 = require("../../../generated/UniswapV2Factory/_ERC20");
...
function bigIntToBigDecimal(quantity, decimals = constants.DEFAULT_DECIMALS.toI32()) {
...
function averagePrice(prices) {
    ...
    return types_1.CustomPriceType.initialize(summationUSDPrice.div(new graph_ts_1.BigDecimal(graph_ts_1.BigInt.fromI32(prices.length))), constants.DEFAULT_USDC_DECIMALS);
}
