...
///////////////////////////////////////////////////////////////////////////
exports.YEARN_LENS_CONTRACT_ADDRESS = new types_1.OracleContract("0x83d95e0d5f402511db06817aff3f9ea88224b030", 12242339);
exports.CHAIN_LINK_CONTRACT_ADDRESS = new types_1.OracleContract("0x47fb2585d2c56fe188d0e6ec628a38b74fceeedf", 12864088);
exports.AAVE_ORACLE_CONTRACT_ADDRESS = new types_1.OracleContract();
exports.SUSHISWAP_CALCULATIONS_ADDRESS = new types_1.OracleContract("0x8263e161a855b644f582d9c164c66aabee53f927", 12692284);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CURVE CONTRACT //////////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.CURVE_CALCULATIONS_ADDRESS = new types_1.OracleContract("0x25bf7b72815476dd515044f9650bf79bad0df655", 12370088);
// Address Provider: https://etherscan.io/address/0x0000000022d53366457f9d5e68ec105046fc4383
exports.CURVE_REGISTRY_ADDRESSES = [
    new types_1.OracleContract("0x7d86446ddb609ed0f5f8684acf30380a356b2b4c", 11154794),
    new types_1.OracleContract("0x90e00ace148ca3b23ac1bc8c240c2a7dd9c2d7f5", 12195750),
    new types_1.OracleContract("0x8f942c20d02befc377d41445793068908e2250d0", 13986752),
    new types_1.OracleContract("0xf98b45fa17de75fb1ad0e7afd971b0ca00e379fc", 15732062), // Meta Registry
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// UNISWAP FORKS CONTRACT ////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.UNISWAP_FORKS_ROUTER_ADDRESSES = [
    new types_1.OracleContract("0xd9e1ce17f2641f24ae83637ab66a2cca9c378b9f", 10794261),
    new types_1.OracleContract("0x7a250d5630b4cf539739df2c5dacb4c659f2488d", 10207858), // Uniswap
];
///////////////////////////////////////////////////////////////////////////
/////////////////////////// BLACKLISTED TOKENS ////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
class config {
    ...
    getOracleOverride(tokenAddr, block) {
        if (tokenAddr || block) {
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0x090185f2135308bad17527004364ebcc2d37e5f6"), // SPELL
                ].includes(tokenAddr)) {
                return new SpellOverride();
            }
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0xae7ab96520de3a18e5e111b5eaab095312d7fe84"), // stETH
                ].includes(tokenAddr) &&
                block &&
            ...
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0x91b08f4a7c1251dfccf5440f8894f8daa10c8de5"), // BAXA
                ].includes(tokenAddr)) {
                return new BaxaOverride();
            }
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0x077416cc6242b3a7d8e42652b8a6a2599fda4a92"), // DPR
                ].includes(tokenAddr)) {
                return new DelperOverride();
            }
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0xed4064f376cb8d68f770fb1ff088a3d0f3ff5c4d"),
                    graph_ts_1.Address.fromString("0xf985005a3793dba4cce241b3c19ddcd3fe069ff4"),
                    graph_ts_1.Address.fromString("0x971add32ea87f10bd192671630be3be8a11b8623"),
                    graph_ts_1.Address.fromString("0x137469b55d1f15651ba46a89d0588e97dd0b6562"),
                    graph_ts_1.Address.fromString("0x4647b6d835f3b393c7a955df51eefcf0db961606"),
                    graph_ts_1.Address.fromString("0x6359b6d3e327c497453d4376561ee276c6933323"),
                    graph_ts_1.Address.fromString("0x2889302a794da87fbf1d6db415c1492194663d13"),
                    graph_ts_1.Address.fromString("0x3a283d9c08e8b55966afb64c515f5143cf907611"),
                    //
                    graph_ts_1.Address.fromString("0x7f86bf177dd4f3494b841a37e810a34dd56c829b"),
                    graph_ts_1.Address.fromString("0xf5f5b97624542d72a9e06f04804bf81baa15e2b4"),
                    graph_ts_1.Address.fromString("0x4ebdf703948ddcea3b11f675b4d1fba9d2414a14"),
                    graph_ts_1.Address.fromString("0xf3a43307dcafa93275993862aae628fcb50dc768"),
                    graph_ts_1.Address.fromString("0xb79565c01b7ae53618d9b847b9443aaf4f9011e7"),
                    graph_ts_1.Address.fromString("0x4704ab1fb693ce163f7c9d3a31b3ff4eaf797714"),
                    graph_ts_1.Address.fromString("0xda68f66fc0f10ee61048e70106df4bdb26baf595"),
                    graph_ts_1.Address.fromString("0x5be6c45e2d074faa20700c49ada3e88a1cc0025d"),
                    graph_ts_1.Address.fromString("0x8109a51542294cdbb489ae5516f42ffbd92177aa"),
                    graph_ts_1.Address.fromString("0x390f3595bca2df7d23783dfd126427cceb997bf4"),
                    graph_ts_1.Address.fromString("0x4dece678ceceb27446b35c672dc7d61f30bad69e"), // Factory Plain Pool: crvUSD/USDC
                ].includes(tokenAddr)) {
                return new CurveFactoryPoolOverride();
            }
            if (tokenAddr &&
                [
                    graph_ts_1.Address.fromString("0xdbdb4d16eda451d0503b854cf79d55697f90c8df"),
                    graph_ts_1.Address.fromString("0x62b9c7356a2dc64a1969e19c23e4f579f9810aa7"),
                    graph_ts_1.Address.fromString("0x1ceb5cb57c4d4e2b2433641b95dd330a33185a44"),
                    graph_ts_1.Address.fromString("0x73968b9a57c6e53d41345fd57a6e6ae27d6cdb2f"),
                    graph_ts_1.Address.fromString("0xba3335588d9403515223f109edc4eb7269a9ab5d"), // GEAR
                ].includes(tokenAddr)) {
