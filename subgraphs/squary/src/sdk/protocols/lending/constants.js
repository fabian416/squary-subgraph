...
exports.bigIntToBigDecimal = exports.exponentToBigDecimal = exports.cTokenDecimalsBD = exports.mantissaFactorBD = exports.cTokenDecimals = exports.mantissaFactor = exports.ARBITRUM_BLOCKS_PER_YEAR = exports.MATIC_BLOCKS_PER_YEAR = exports.BSC_BLOCKS_PER_YEAR = exports.FANTOM_BLOCKS_PER_YEAR = exports.AVALANCHE_BLOCKS_PER_YEAR = exports.ETHEREUM_BLOCKS_PER_YEAR = exports.SECONDS_PER_HOUR = exports.SECONDS_PER_DAY = exports.SECONDS_PER_YEAR = exports.DAYS_PER_YEAR = exports.BIGDECIMAL_HUNDRED = exports.BIGDECIMAL_ONE = exports.BIGDECIMAL_ZERO = exports.BIGINT_TEN_TO_EIGHTEENTH = exports.BIGINT_THREE_HUNDRED = exports.BIGINT_HUNDRED = exports.BIGINT_ONE = exports.BIGINT_ZERO = exports.BIGINT_NEGATIVE_ONE = exports.INT_EIGHTTEEN = exports.INT_SIXTEEN = exports.INT_NINE = exports.INT_SIX = exports.INT_FOUR = exports.INT_TWO = exports.INT_ONE = exports.INT_ZERO = exports.INT_NEGATIVE_ONE = exports.Transaction = exports.RewardTokenType = exports.AccountActivity = exports.TransactionType = exports.OracleSource = exports.PositionSide = exports.FeeType = exports.InterestRateSide = exports.InterestRateType = exports.TokenType = exports.CollateralizationType = exports.RiskType = exports.PermissionType = exports.LendingType = exports.ProtocolType = exports.Network = void 0;
exports.ZERO_ADDRESS = exports.activityCounter = exports.insert = exports.BDChangeDecimals = void 0;
...
function activityCounter(account, transactionType, useTransactionType, intervalID, // 0 = no intervalID
marketID = null) {
