...
class DataManager {
    ...
    //// Creators ////
    //////////////////
    createDeposit(asset, account, amount, amountUSD, newBalance, interestType = null, principal = null) {
        ...
        position.addPosition(this.event, asset, this.protocol, newBalance, constants_1.TransactionType.DEPOSIT, this.market.inputTokenPriceUSD, principal);
    ...
    createWithdraw(asset, account, amount, amountUSD, newBalance, interestType = null, principal = null) {
        ...
        position.subtractPosition(this.event, this.protocol, newBalance, constants_1.TransactionType.WITHDRAW, this.market.inputTokenPriceUSD, principal);
    ...
    interestType = null, principal = null) {
        ...
        position.addPosition(this.event, asset, this.protocol, newBalance, constants_1.TransactionType.BORROW, tokenPriceUSD, principal);
    ...
    interestType = null, principal = null) {
        ...
        position.subtractPosition(this.event, this.protocol, newBalance, constants_1.TransactionType.REPAY, tokenPriceUSD, principal);
        const positionID = position.getPositionID();
        if (!positionID) {
    ...
    interestType = null, principal = null) {
        ...
        liquidateePosition.subtractPosition(this.event, this.protocol, newBalance, constants_1.TransactionType.LIQUIDATE, this.market.inputTokenPriceUSD, principal);
        // Note:
    ...
    createTransfer(asset, sender, receiver, amount, amountUSD, senderNewBalance, receiverNewBalance, interestType = null, senderPrincipal = null, receiverPrincipal = null) {
        ...
        transferrerPosition.subtractPosition(this.event, this.protocol, senderNewBalance, constants_1.TransactionType.TRANSFER, this.market.inputTokenPriceUSD, senderPrincipal);
        ...
        receiverPosition.addPosition(this.event, asset, this.protocol, receiverNewBalance, constants_1.TransactionType.TRANSFER, this.market.inputTokenPriceUSD, receiverPrincipal);
    ...
    updateMarketAndProtocolData(inputTokenPriceUSD, newInputTokenBalance, newVariableBorrowBalance = null, newStableBorrowBalance = null, newReserveBalance = null, exchangeRate = null, outputTokenSupply = null) {
