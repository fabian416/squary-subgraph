...
const ERC20_1 = require("../../../../generated/Configurator/ERC20");
const ERC20SymbolBytes_1 = require("../../../../generated/Configurator/ERC20SymbolBytes");
const ERC20NameBytes_1 = require("../../../../generated/Configurator/ERC20NameBytes");
...
class TokenManager {
    constructor(tokenAddress, event, tokenType = null) {
        ...
        if (!_token) {
            ...
            _token.name = this.fetchTokenName(graph_ts_1.Address.fromBytes(tokenAddress));
            _token.symbol = this.fetchTokenSymbol(graph_ts_1.Address.fromBytes(tokenAddress));
            _token.decimals = this.fetchTokenDecimals(graph_ts_1.Address.fromBytes(tokenAddress));
            if (tokenType) {
...
class StaticTokenDefinition {
    ...
    static getStaticDefinitions() {
        ...
        // Add DGD
        const tokenDGD = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xe0b7927c4af23765cb51314a0e0521a9645f0e2a"), "DGD", "DGD", constants_1.INT_NINE);
        staticDefinitions.push(tokenDGD);
        // Add AAVE
        const tokenAAVE = new StaticTokenDefinition(graph_ts_1.Address.fromString("0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9"), "AAVE", "Aave Token", constants_1.INT_EIGHTTEEN);
        staticDefinitions.push(tokenAAVE);
        // Add LIF
        const tokenLIF = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xeb9951021698b42e4399f9cbb6267aa35f82d59d"), "LIF", "Lif", constants_1.INT_EIGHTTEEN);
        staticDefinitions.push(tokenLIF);
        // Add SVD
        const tokenSVD = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xbdeb4b83251fb146687fa19d1c660f99411eefe3"), "SVD", "savedroid", constants_1.INT_EIGHTTEEN);
        staticDefinitions.push(tokenSVD);
        // Add TheDAO
        const tokenTheDAO = new StaticTokenDefinition(graph_ts_1.Address.fromString("0xbb9bc244d798123fde783fcc1c72d3bb8c189413"), "TheDAO", "TheDAO", constants_1.INT_SIXTEEN);
        staticDefinitions.push(tokenTheDAO);
        // Add HPB
        const tokenHPB = new StaticTokenDefinition(graph_ts_1.Address.fromString("0x38c6a68304cdefb9bec48bbfaaba5c5b47818bb2"), "HPB", "HPBCoin", constants_1.INT_EIGHTTEEN);
