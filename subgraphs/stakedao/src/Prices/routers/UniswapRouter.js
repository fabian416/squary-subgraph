...
function getPriceFromRouter(token0Address, token1Address, network) {
    ...
    if (routerAddressV1) {
        ...
        let amountOutBigDecimal = amountOut
            ...
            .toBigDecimal();
        return types_1.CustomPriceType.initialize(amountOutBigDecimal, 6);
    }
    return new types_1.CustomPriceType();
}
...
function getLpTokenPriceUsdc(tokenAddress, network) {
    ...
    return types_1.CustomPriceType.initialize(pricePerLpTokenUsdc, 6);
}
...
function getLpTokenTotalLiquidityUsdc(tokenAddress, network) {
    ...
    if (reserve0.notEqual(constants.BIGINT_ZERO) ||
        ...
        return types_1.CustomPriceType.initialize(totalLiquidity, 6);
    }
    return new types_1.CustomPriceType();
}
