...
const CurvePool_1 = require("../../../generated/LPStaking_0/CurvePool");
const CurveRegistry_1 = require("../../../generated/LPStaking_0/CurveRegistry");
...
function getPreferredCoinFromCoins(coins) {
    ...
    for (let coinIdx = 0; coinIdx < constants_1.INT_EIGHT; coinIdx++) {
...
function getPriceUsdc(tokenAddress) {
    ...
    const virtualPrice = utils
        ...
        .toBigDecimal();
    const coins = [];
    for (let i = 0; i < constants_1.INT_EIGHT; i++) {
