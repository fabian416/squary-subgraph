...
class Pool {
    ...
    getInputTokenAmountPrice(amount) {
        ...
        token.save();
        const amountUSD = (0, numbers_1.bigIntToBigDecimal)(amount, token.decimals).times(price);
        return amountUSD;
    }
    /**
    ...
    trackWithdraw(withdraw) {
        ...
        this.addInputTokenBalance(withdraw.amount.times(constants_1.BIGINT_MINUS_ONE));
    }
}
exports.Pool = Pool;
/**
