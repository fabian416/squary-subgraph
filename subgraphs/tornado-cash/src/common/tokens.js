...
exports.isNativeToken = exports.isRewardToken = exports.isNullEthValue = exports.fetchTokenDecimals = exports.fetchTokenName = exports.fetchTokenSymbol = exports.UNKNOWN_TOKEN_VALUE = exports.INVALID_TOKEN_DECIMALS = void 0;
/* eslint-disable prefer-const */
const graph_ts_1 = require("@graphprotocol/graph-ts");
const configure_1 = require("../../configurations/configure");
const ERC20_1 = require("../../generated/TornadoCash01/ERC20");
const ERC20SymbolBytes_1 = require("../../generated/TornadoCash01/ERC20SymbolBytes");
const ERC20NameBytes_1 = require("../../generated/TornadoCash01/ERC20NameBytes");
...
function isRewardToken(tokenAddress) {
    return (tokenAddress ==
        graph_ts_1.Address.fromString(configure_1.NetworkConfigs.getRewardToken().get("address")));
}
exports.isRewardToken = isRewardToken;
function isNativeToken(tokenAddress) {
    return (tokenAddress ==
        graph_ts_1.Address.fromString(configure_1.NetworkConfigs.getNativeToken().get("address")));
}
