...
exports.WHITELIST_TOKENS_MAP = exports.USDC_DECIMALS_MAP = exports.UNISWAP_cDAI_CONTRACT_ADDRESS = exports.UNISWAP_USDC_CONTRACT_ADDRESS = exports.UNISWAP_DAI_CONTRACT_ADDRESS = exports.CHAIN_LINK_CONTRACT_ADDRESS = exports.YEARN_LENS_CONTRACT_ADDRESS = exports.UNISWAP_PATH_OVERRIDES = exports.UNISWAP_ROUTER_CONTRACT_ADDRESSES = exports.UNISWAP_DEFAULT_RESERVE_CALL = exports.SUSHISWAP_ROUTER_ADDRESS_MAP = exports.SUSHISWAP_WETH_ADDRESS = exports.SUSHISWAP_CALCULATIONS_ADDRESS_MAP = exports.SUSHISWAP_DEFAULT_RESERVE_CALL = exports.CURVE_POOL_REGISTRY_ADDRESS_MAP = exports.CURVE_REGISTRY_ADDRESS_MAP = exports.CURVE_CALCULATIONS_ADDRESS_MAP = exports.WHITELIST_TOKENS_LIST = exports.CHAIN_LINK_USD_ADDRESS = exports.ZERO_ADDRESS = exports.ZERO_ADDRESS_STRING = exports.DEFAULT_DECIMALS = exports.DEFAULT_cDAI_DECIMALS = exports.DEFAULT_ETH_DECIMALS = exports.DEFAULT_DAI_DECIMALS = exports.DEFAULT_USDT_DECIMALS = exports.DEFAULT_USDC_DECIMALS = exports.BIGDECIMAL_ZERO = exports.BIGINT_TEN_THOUSAND = exports.BIGINT_TEN = exports.BIGINT_ZERO = void 0;
...
const UniswapPair_1 = require("../../../generated/TornadoCash01/UniswapPair");
const SushiSwapPair_1 = require("../../../generated/TornadoCash01/SushiSwapPair");
///////////////////////////////////////////////////////////////////////////
/////////////////////////////////// COMMON ////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.DEFAULT_USDT_DECIMALS = 6;
exports.DEFAULT_DAI_DECIMALS = 18;
exports.DEFAULT_ETH_DECIMALS = 18;
exports.DEFAULT_cDAI_DECIMALS = 8;
...
exports.CURVE_CALCULATIONS_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.CURVE_CALCULATIONS_ADDRESS);
...
exports.CURVE_CALCULATIONS_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_CALCULATIONS_ADDRESS);
...
exports.CURVE_REGISTRY_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.CURVE_REGISTRY_ADDRESS);
...
exports.CURVE_REGISTRY_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_REGISTRY_ADDRESS);
...
exports.CURVE_POOL_REGISTRY_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.CURVE_POOL_REGISTRY_ADDRESS);
...
exports.CURVE_POOL_REGISTRY_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.CURVE_POOL_REGISTRY_ADDRESS);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// SUSHISWAP CONTRACT //////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.SUSHISWAP_CALCULATIONS_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.SUSHISWAP_CALCULATIONS_ADDRESS);
...
exports.SUSHISWAP_CALCULATIONS_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_CALCULATIONS_ADDRESS);
...
exports.SUSHISWAP_WETH_ADDRESS.set(BSC.NETWORK_STRING, BSC.SUSHISWAP_WETH_ADDRESS);
...
exports.SUSHISWAP_WETH_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_WETH_ADDRESS);
...
exports.SUSHISWAP_ROUTER_ADDRESS_MAP.set(BSC.NETWORK_STRING, BSC.SUSHISWAP_ROUTER_ADDRESS);
...
exports.SUSHISWAP_ROUTER_ADDRESS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.SUSHISWAP_ROUTER_ADDRESS);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// UNISWAP CONTRACT ////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.UNISWAP_ROUTER_CONTRACT_ADDRESSES.set(BSC.NETWORK_STRING, BSC.UNISWAP_ROUTER_ADDRESS);
...
exports.UNISWAP_ROUTER_CONTRACT_ADDRESSES.set(POLYGON.NETWORK_STRING, POLYGON.QUICKSWAP_ROUTER_ADDRESS);
exports.UNISWAP_PATH_OVERRIDES = new graph_ts_1.TypedMap();
exports.UNISWAP_PATH_OVERRIDES.set(MAINNET.NETWORK_STRING, MAINNET.UNISWAP_PATH_OVERRIDE);
exports.UNISWAP_PATH_OVERRIDES.set(BSC.NETWORK_STRING, BSC.UNISWAP_PATH_OVERRIDE);
exports.UNISWAP_PATH_OVERRIDES.set(FANTOM.NETWORK_STRING, FANTOM.SPOOKY_SWAP_PATH_OVERRIDE);
exports.UNISWAP_PATH_OVERRIDES.set(ARBITRUM_ONE.NETWORK_STRING, ARBITRUM_ONE.UNISWAP_PATH_OVERRIDE);
exports.UNISWAP_PATH_OVERRIDES.set(POLYGON.NETWORK_STRING, POLYGON.QUICKSWAP_PATH_OVERRIDE);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// YEARNLENS CONTRACT //////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.YEARN_LENS_CONTRACT_ADDRESS.set(BSC.NETWORK_STRING, BSC.YEARN_LENS_CONTRACT_ADDRESS);
...
exports.YEARN_LENS_CONTRACT_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.YEARN_LENS_CONTRACT_ADDRESS);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// CHAINLINK CONTRACT //////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.CHAIN_LINK_CONTRACT_ADDRESS.set(BSC.NETWORK_STRING, BSC.CHAIN_LINK_CONTRACT_ADDRESS);
...
exports.CHAIN_LINK_CONTRACT_ADDRESS.set(POLYGON.NETWORK_STRING, POLYGON.CHAIN_LINK_CONTRACT_ADDRESS);
///////////////////////////////////////////////////////////////////////////
///////////////////////////// UNISWAP V1 CONTRACT /////////////////////////
///////////////////////////////////////////////////////////////////////////
exports.UNISWAP_DAI_CONTRACT_ADDRESS = new Map();
exports.UNISWAP_DAI_CONTRACT_ADDRESS.set(MAINNET.NETWORK_STRING, MAINNET.UNISWAP_DAI_CONTRACT_ADDRESS);
exports.UNISWAP_USDC_CONTRACT_ADDRESS = new Map();
exports.UNISWAP_USDC_CONTRACT_ADDRESS.set(MAINNET.NETWORK_STRING, MAINNET.UNISWAP_USDC_CONTRACT_ADDRESS);
exports.UNISWAP_cDAI_CONTRACT_ADDRESS = new Map();
exports.UNISWAP_cDAI_CONTRACT_ADDRESS.set(MAINNET.NETWORK_STRING, MAINNET.UNISWAP_cDAI_CONTRACT_ADDRESS);
///////////////////////////////////////////////////////////////////////////
///////////////////////////////// HELPERS /////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
exports.USDC_DECIMALS_MAP.set(ARBITRUM_ONE.NETWORK_STRING, ARBITRUM_ONE.USDC_DECIMALS);
...
exports.WHITELIST_TOKENS_MAP.set(POLYGON.NETWORK_STRING, POLYGON.WHITELIST_TOKENS);
