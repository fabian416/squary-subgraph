...
const MasterChefSpookyswap_1 = require("../../../../../generated/MasterChef/MasterChefSpookyswap");
...
function handleReward(event, pid, amount) {
    const poolContract = MasterChefSpookyswap_1.MasterChefSpookyswap.bind(event.address);
