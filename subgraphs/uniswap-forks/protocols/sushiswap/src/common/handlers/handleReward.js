...
const MasterChefSushiswap_1 = require("../../../../../generated/MasterChef/MasterChefSushiswap");
...
function handleReward(event, pid, amount) {
    const poolContract = MasterChefSushiswap_1.MasterChefSushiswap.bind(event.address);
