...
exports.getRewardsPerDay = exports.WINDOW_SIZE_SECONDS_BD = exports.STARTING_BLOCKS_PER_DAY = exports.RATE_IN_SECONDS_BD = exports.RATE_IN_SECONDS = exports.RewardIntervalType = exports.CIRCULAR_BUFFER = exports.BUFFER_SIZE = exports.WINDOW_SIZE_SECONDS = exports.TIMESTAMP_STORAGE_INTERVAL = void 0;
...
function getRewardsPerDay(currentTimestamp, currentBlockNumber, rewardRate, rewardType) {
    if (rewardType == RewardIntervalType.NONE) {
        graph_ts_1.log.warning("Reward type is NONE. Returning 0.", []);
    ...
    if (windowSecondsCount.notEqual(constants_2.BIGDECIMAL_ZERO)) {
        // Wideness of the window in blocks.
        const windowBlocksCount = graph_ts_1.BigDecimal.fromString((currentBlockNumberI32 -
            blocks[circularBuffer.windowStartIndex + constants_2.INT_ONE]).toString());
...
function getStartingBlockRate() {
    ...
    else if (configure_1.NetworkConfigs.getNetwork() == constants_1.Network.GNOSIS) {
        return graph_ts_1.BigDecimal.fromString("5");
    }
    ...
    else if (configure_1.NetworkConfigs.getNetwork() == constants_1.Network.HARMONY) {
        return graph_ts_1.BigDecimal.fromString("0.5");
    }
