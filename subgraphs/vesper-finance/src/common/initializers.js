...
exports.getOrCreateVault = exports.getOrCreateVaultsHourlySnapshots = exports.getOrCreateVaultsDailySnapshots = exports.getOrCreateUsageMetricsHourlySnapshot = exports.getOrCreateUsageMetricsDailySnapshot = exports.getOrCreateFinancialDailySnapshots = exports.getOrCreateToken = exports.getOrCreateYieldAggregator = exports.getOrCreateFee = exports.getOrCreateRewardToken = exports.getOrCreateAccount = void 0;
...
const ERC20_1 = require("../../generated/templates/PoolRewards/ERC20");
...
function getOrCreateFee(feeId, feeType, feePercentage = constants.BIGINT_ZERO) {
...
function getOrCreateVault(vaultAddress, block) {
    ...
    if (!vault) {
        ...
        vault.depositLimit = utils.readValue(vaultContract.try_minDepositLimit(), constants.BIGINT_ZERO);
        ...
        const poolAccountant = utils.readValue(vaultContract.try_poolAccountant(), constants.NULL.TYPE_ADDRESS);
        if (poolAccountant.notEqual(constants.NULL.TYPE_ADDRESS))
            templates_1.PoolAccountant.create(poolAccountant);
        utils.updateProtocolAfterNewVault(vaultAddress);
        vault.save();
        graph_ts_1.log.warning("[NewVault] vault: {}, name: {}, inputToken: {}, poolAccountant: {}", [
            vaultAddress.toHexString(),
            vault.name,
            inputToken.id,
