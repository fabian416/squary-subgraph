...
const CurveRegistry_1 = require("../../../generated/Registry_v1/CurveRegistry");
const CurvePoolRegistry_1 = require("../../../generated/Registry_v1/CurvePoolRegistry");
function getCurvePriceUsdc(curveLpTokenAddress, network) {
    ...
    return types_1.CustomPriceType.initialize(price, 6);
}
