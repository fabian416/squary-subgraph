...
const UniswapPair_1 = require("../../../generated/Registry_v1/UniswapPair");
const graph_ts_1 = require("@graphprotocol/graph-ts");
const UniswapRouter_1 = require("../../../generated/Registry_v1/UniswapRouter");
...
function getLpTokenTotalLiquidityUsdc(tokenAddress, network) {
    const uniSwapPair = UniswapPair_1.UniswapPair.bind(tokenAddress);
    const token0Address = utils.readValue(uniSwapPair.try_token0(), constants.ZERO_ADDRESS);
    const token1Address = utils.readValue(uniSwapPair.try_token1(), constants.ZERO_ADDRESS);
    ...
    const reserves = utils.readValue(uniSwapPair.try_getReserves(), constants.UNISWAP_DEFAULT_RESERVE_CALL);
